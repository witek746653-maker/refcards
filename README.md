...
- **Purpose:** описывает, как взаимодействовать с репозиторием при помощи AI-агентов и какие практики соблюдать.
- **Файл с общими правилами:** [refcards/AGENTS.md](refcards/AGENTS.md) — содержит инструкции по структуре проекта, обработке Markdown-карточек, безопасности и тестам.
- **Локальные правила/контекст:** набор файлов в [refcards/.cursor/rules](refcards/.cursor/rules) с детальными нишевыми рекомендациями для структуры, бэкенда, фронтенда, данных и тестирования.
- **Рекомендация по изменениям:** любые изменения, влияющие на формат карточек, API или миграции БД, должны сопровождаться описанием миграции и обновлением тестов.
